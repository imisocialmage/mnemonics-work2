...
export const STRATEGIC_ADVICE = {
    acquisition: {
        ...
        tips: [
            "Align your online presence with your authentic brand intent",
            "Engage in meaningful conversations, not just broadcasts",
            "Demonstrate value through authentic micro-conversions",
            "Map your outreach to the prospect's real emotional triggers",
            "Focus on high-trust platforms where your ideal 'Who' resides",
            "Replace aggressive 'Sales Speak' with 'Help Language'",
            "Use educational assets to build authority before the ask",
            "Ensure your 'How' methodology is visible and transparent",
            "Listen more than you speak in early relationship stages",
            "Iterate your profile based on real conversational feedback"
        ],
        sevenDayPlan: [
    ...
    conversion: {
        ...
        tips: [
            "Replace high-friction forms with low-friction dialogues",
            "Use social proof as evidence of results, not just fluff",
            "Guide prospects to the next logical step in their journey",
            "Create 'Trust Slopes' instead of aggressive funnels",
            "Address deep-seated objections through transparent Q&A",
            "Use 'Soft Asks' to gauge readiness for transformation",
            "Showcase the 'Mechanism' that makes your product work",
            "Personalize follow-ups based on specific pain points",
            "Eliminate 'Coercive' urgency in favor of 'Value' relevance",
            "Ensure a seamless transition from browser to buyer"
        ],
        sevenDayPlan: [
    ...
    retention: {
        ...
        tips: [
            "Deepen the relationship through consistent value delivery",
            "Turn your service process into a 'Member Experience'",
            "Proactively solve problems before the client notices them",
            "Celebrate client wins as if they were your own",
            "Incorporate 'Human-to-Human' check-ins regularly",
            "Create a community where clients can grow together",
            "Align your ongoing product updates with client feedback",
            "Surprise and delight through unexpected personalization",
            "Shift from 'Vendor' to 'Long-term Strategic Partner'",
            "Reward loyalty with early access to IMI insights"
        ],
        sevenDayPlan: [
